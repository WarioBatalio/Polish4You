                ...
                <article>
                    ...
                    <div>
                        ...
                        <ul className="Normal-DP">
                            <li><b>bклассические курсы общего языка</b> на всех уровнях знаний - от начального до профессионального</li>
                        </ul>
                        <ul className="Normal-DP">
                        ...
                        <ul className="Normal-DP">
                            <li><b>подготовка к сдаче государственных сертификационных экзаменов</b> на всех уровнях знаний</li>
                        </ul>
                        <ul className="Normal-DP">
                            <li><b>занятия для детей</b> (с семи лет)</li>
                        </ul>
                        <ul className="Normal-DP">
                            <li><b>курсы дистанционного обучения</b> - по Skype, Zoom, WhatsApp, Messenger (режим видео-чата)</li>
                        </ul>
                        <ul className="Normal-DP">
                    ...
                    <div>
                        ...
                        <ul className="Normal-DP">
                            <li>в случае курсов корпоративного обучения количество участников определяется индивидуально</li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="Normal-DP">
                            <li>дистанционным обучением - т.е. уроками в режиме видео-чата (по Skype, Zoom, WhatsApp, Messenger)</li>
                        </ul>
                    </div>
                    <div className="Desktop-Rounded-Box">
                        <p>
                            Перед началом индивидуального курса приглашаю на <b>бесплатный пробный урок</b>.
                            (60 минут). Цель этого урока - познакомиться друг с другом, проверить уровень знания польского
                            языка, обсудить связанные с курсом вопросы и помочь в принятии окончательного решения приступить к нему.
                        </p>
                    </div>
                </article>
            </main>
